📘 F조 영단어 학습 플랫폼 (English Vocabulary Platform)
누구나 쉽고 안전하게. 수준별 맞춤 영단어를 학습하고 퀴즈로 실력을 점검하는 웹 서비스입니다.

1. 프로젝트 소개
F조 영단어 학습 플랫폼은 사용자의 영어 실력(난이도)에 맞춰 체계적으로 단어를 암기할 수 있도록 돕습니다. 단순한 암기를 넘어, Spring Security를 적용하여 개인정보를 안전하게 보호하며, 퀴즈와 랭킹 시스템을 통해 학습 동기를 부여합니다.
